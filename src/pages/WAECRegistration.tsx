...
const WAEC_REGISTRATION_AMOUNT = 14500;

export function WAECRegistration() {
  const { user } = useAuth();
  ...
  return (
    <div>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex" ref={bodyDivRef}>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <Header
            ...
            subtitle="Register for WAEC examination"
            showBackButton={true}
          />
                  ...
                  <div className="space-y-4">
                    <div className="bg-sky-50 dark:bg-sky-900/20 rounded-xl p-4">
                      <p className="text-sm text-sky-600 dark:text-sky-400">
                        WAEC Registration allows you to register for the West African Examinations Council (WAEC) examination.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-4">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">₦{WAEC_REGISTRATION_AMOUNT.toLocaleString()}</span>
                      </div>
                    </div>
      ...
      <LoaderComponent />
      <PinComponent type="waec-registration" value={payload} />
      <ToastComponent />
      {isOpen && (
